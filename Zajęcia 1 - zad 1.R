...
przeciwprostokatna = function(bok1, bok2){
  return( sqrt(bok1^2 + bok2^2 ))
}

przeciwprostokatna(1,2)
przeciwprostokatna(3,8)
...
kalkulator = function(dzialanie, liczba1, liczba2){
  if(dzialanie == 1){
...
podatek = function(typ, dochod){
  ...
  if(typ == 1){
      ...
      if(dochod <= 85528){
        ...
        return(85528*0.18 + (dochod-85528)*0.32)
      }
    }
  else{
    print("Ujemny dochod")
